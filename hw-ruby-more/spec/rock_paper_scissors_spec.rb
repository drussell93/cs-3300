...
describe RockPaperScissors do
  ...
  it "should raise NoSuchStrategyError if strategy isn't R, P, or S (Player 1)" do
    expect(lambda { RockPaperScissors.winner(['Dave', 'w'], @rock) }).to raise_error(RockPaperScissors::NoSuchStrategyError, "Strategy must be one of R,P,S")
  end
